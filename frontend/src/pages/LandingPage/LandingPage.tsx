...
export default function LandingPage() {
  ...
  return (
    <main>
      <div ref={rootRef} className="w-full h-screen relative bg-[#FBF3F0] overflow-x-hidden">
        <div className="absolute">
          ...
          <div className="flex items-center gap-3 bg-white rounded-full shadow-md fixed top-10 right-10 z-[100]">
            <Link to="/login">
              <button className="hidden md:block font-medium px-5 py-2 bg-[#fff] text-sm font-semibold rounded-full hover:bg-[#1c99c6] transition-colors text-black/60 shadow-lg">
                Login
              </button>
            </Link>
          </div>
          ...
          <div className="relative pt-100 lg:pt-120">
            <div className="mx-auto max-w-7xl px-6">
              <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0 ">
                <a
                  href="#"
                  className="hidden md:block font-medium bg-background group mx-auto flex w-fit items-center gap-4 rounded-full border p-8 pl-4 shadow-md transition-colors duration-300"
                  data-scroll-reveal
                  data-fade="true"
                >
                  ...
                  <span className="block h-4 w-0.5 border-l hidden md:block font-medium"></span>
                  <div className="group-hover:bg-gray-50 size-6 overflow-hidden rounded-full duration-500 hidden md:block font-medium">
