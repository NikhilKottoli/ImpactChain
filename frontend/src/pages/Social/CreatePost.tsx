...
export default function CreatePost() {
  ...
  useEffect(() => {
    ...
    const apiKey = import.meta.env.VITE_LIGHTHOUSE_API_KEY || '239777d2.c5fe3f8d06e34c27be7f7d5cf99f007d';
          ...
          <div className="max-w-md mx-auto text-center py-12">
            <div className="bg-white rounded-lg shadow-md p-8">
              ...
              <p className="text-gray-600 mb-6">
                You need to connect your Web3 wallet to create posts on the blockchain
              </p>
              <WalletConnect />
            </div>
          </div>
        ) : (
          hasLighthouseKey ? <PostCreatorWithLighthouse /> : <SimpleCreatePost />
        )}
      </div>
    </div>
  );
