...
import { useWallet, usePosts, useContract, useUserPosts } from '../../hooks/useContract';
import { IPFSImageViewer, PostImageViewer } from '../../components/IPFSImageViewer';
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-purple-50 pt-20">
      <div className="container mx-auto px-4 py-8">
          ...
          <div className="text-center py-12">
            <div className="bg-white rounded-lg shadow-md p-8 max-w-md mx-auto">
              ...
              <p className="text-gray-600 mb-4">
                Connect your Web3 wallet to view your profile and interact with the platform
              </p>
              <WalletConnect />
            </div>
          </div>
        ...
        {activeTab === 'profile' && isConnected && (
          <div className="max-w-4xl mx-auto">
            <ProfileSection address={address!} onCreatePost={() => navigate('/createpost')} />
          </div>
        )}
      </div>
    </div>
    ...
    <div className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow">
      ...
      <div className="p-4">
        ...
        <div className="flex items-center justify-between text-sm text-gray-500 mb-3">
          ...
          <span>{new Date(Number(post.timestamp) * 1000).toLocaleDateString()}</span>
        </div>
...
function ProfileSection({ address, onCreatePost }: { address: string; onCreatePost: () => void }) {
